...
public class ColorPickerDialog extends Dialog {
	...
	public ColorPickerDialog(Context context, OnColorChangedListener listener, String key, int initialColor, int defaultColor, int posX, int posY){
		super(context);
		
		this.listener = listener;
		ColorPickerDialog.key = key;
